...
class Platform_engine:
   ...
   def get_matching_tors_for_reqs(self, rack):
      ...
      valid_net_sku = self.match_tor_to_network_reqs(rack,valid_feature_skus)
      return valid_net_sku
   ...
   def match_tor_to_network_reqs(self,rack,candidate_skus):
      ...
      for sku in candidate_skus:
         if sku.ports.can_support_rack_port_requirements(rack):
